        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="order-box">
                    ...
                    <br>
                    <hr>
                    <label class="row"><span class="col-md-2 float-left">Quantity: </span><input type="number" name="quantity" id="quantity" min="1" :max="product.units" class="col-md-2 float-left" v-model="quantity" @change="checkUnits"></label>
                </div>
                <br>
                <div>
                    <div v-if="!isLoggedIn">
                    ...
                    <div v-if="isLoggedIn">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input id="payment_method" type="text" class="form-control" v-model="payment_method" required>
                            </div>
                        </div>
                        <br>
